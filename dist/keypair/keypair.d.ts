 ...
 */
export declare const getPrivateKeyStr: (keypair: ledgerTypes.XfrKeyPair) => Promise<string>;
export declare const getPublicKeyStr: (keypair: ledgerTypes.XfrKeyPair) => Promise<string>;
export declare const getAddress: (keypair: ledgerTypes.XfrKeyPair) => Promise<string>;
export declare const getAddressByPublicKey: (publicKey: string) => Promise<string>;
/**
 * @todo Add unit test
 */
export declare const getXfrPublicKeyByBase64: (publicKey: string) => Promise<ledgerTypes.XfrPublicKey>;
/**
 * @todo Add unit test
 */
export declare const getPublicKeyByXfr: (publicKey: ledgerTypes.XfrPublicKey) => Promise<string>;
export declare const getAXfrPublicKeyByBase64: (publicKey: string) => Promise<ledgerTypes.AXfrPubKey>;
export declare const getAXfrPrivateKeyByBase64: (privateKey: string) => Promise<ledgerTypes.AXfrKeyPair>;
export declare const getAxfrPubKeyByBase64: (publicKey: string) => Promise<ledgerTypes.AXfrPubKey>;
