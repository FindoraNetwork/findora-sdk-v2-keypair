 ...
 */
export const getPrivateKeyStr = async (keypair: ledgerTypes.XfrKeyPair): Promise<string> => {
  const ledger = await getLedger();
...
export const getPublicKeyStr = async (keypair: ledgerTypes.XfrKeyPair): Promise<string> => {
  const ledger = await getLedger();
...
export const getAddress = async (keypair: ledgerTypes.XfrKeyPair): Promise<string> => {
  const ledger = await getLedger();
  try {
 ...
 * @todo Add unit test
 */
export const getXfrPublicKeyByBase64 = async (publicKey: string): Promise<ledgerTypes.XfrPublicKey> => {
  const ledger = await getLedger();
  try {
 ...
 * @todo Add unit test
 */
export const getPublicKeyByXfr = async (publicKey: ledgerTypes.XfrPublicKey): Promise<string> => {
  const ledger = await getLedger();
  try {
...
export const getAXfrPublicKeyByBase64 = async (publicKey: string): Promise<ledgerTypes.AXfrPubKey> => {
  const ledger = await getLedger();
  try {
...
export const getAXfrPrivateKeyByBase64 = async (privateKey: string): Promise<ledgerTypes.AXfrKeyPair> => {
  const ledger = await getLedger();
  try {
...
export const getAxfrPubKeyByBase64 = async (publicKey: string): Promise<ledgerTypes.AXfrPubKey> => {
  const ledger = await getLedger();
  try {
    return ledger.axfr_pubkey_from_string(publicKey);
  } catch (err) {
...
export const restoreFromMnemonic = async (
  ...
  let keypair: ledgerTypes.XfrKeyPair;
  if (isFraAddress) {
